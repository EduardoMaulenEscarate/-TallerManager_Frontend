...
/**
 * @fileoverview Componente para el formulario de registro de usuario
                 Permite agregar, editar y deshabilitar un usuario
 * @param {function} handleChange - Función para manejar el cambio de los inputs
